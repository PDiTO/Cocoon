...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FrequencyLastPai")));
bytes32 constant FrequencyLastPaidTableId = _tableId;

library FrequencyLastPaid {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FrequencyLastPaid", _fieldNames);
  }
