...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TokenCounter")));
bytes32 constant TokenCounterTableId = _tableId;

library TokenCounter {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TokenCounter", _fieldNames);
  }
