...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FloatingRate")));
bytes32 constant FloatingRateTableId = _tableId;

library FloatingRate {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FloatingRate", _fieldNames);
  }
