...
library Owner {
  ...
  /** Get owner */
  function get(uint256 tokenId) internal view returns (address owner) {
  ...
  function get(IStore _store, uint256 tokenId) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256((tokenId)));
  ...
  /** Set owner */
  function set(uint256 tokenId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256((tokenId)));
  ...
  function set(IStore _store, uint256 tokenId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256((tokenId)));
