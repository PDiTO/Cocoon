...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SecurityCounter")));
bytes32 constant SecurityCounterTableId = _tableId;

library SecurityCounter {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SecurityCounter", _fieldNames);
  }
